...
class MessageRecord extends TableRecord
{
    ...
    private static function workflowTemplates(): array
    {
        $definitions = [
            ...
            ['seq' => 210, 'prefix' => 'training_reflection', 'name' => '实训反思报告', 'panel' => '#panel=practice:reflections'],
            ['seq' => 213, 'prefix' => 'training_journal', 'name' => '实训日志', 'panel' => '#panel=practice:journals'],
            ['seq' => 216, 'prefix' => 'training_report', 'name' => '实训报告', 'panel' => '#panel=practice:reports'],
