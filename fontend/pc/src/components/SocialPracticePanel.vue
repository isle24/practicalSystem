...
.social-practice-form > label { display: grid; gap: 6px; }.social-practice-form > label > span { color: var(--muted); font-size: 12px; }.social-practice-form input,.social-practice-form textarea { width: 100%; box-sizing: border-box; border: 1px solid var(--line); border-radius: 6px; padding: 9px 11px; background: #fff; font: inherit; }.social-practice-form textarea { resize: vertical; line-height: 1.6; }.span-2 { grid-column: 1 / -1; }
